...
export function PlanDashboard({ user, plan, onStartModule, onNavigate, onBack, onToggleSidebar }) {
  const [expandedSubjects, setExpandedSubjects] = useState(new Set(['math']));
  const [expandedModules, setExpandedModules] = useState(new Set(['math-algebra']));
